...
// It can access it because the nested function is within the scope of myFunction
...
function animalNames(data) {
 ...
 data.forEach(function(val, index, data){
  ...
  animalString = "name: " +data[index]['animal_name'] +", ";
  animalString += "scientific: " +data[index]['scientific_name']
...
CuboidMaker.prototype.volume = function (atb) {
...
CuboidMaker.prototype.surfaceArea = function (atb) {
  return (
    2 *
